...
export class Profile extends ethereum.SmartContract {
  ...
  EARLY_ADOPTER_ROLE(): Bytes {
    let result = super.call(
      "EARLY_ADOPTER_ROLE",
      "EARLY_ADOPTER_ROLE():(bytes32)",
      []
    );
  ...
  try_EARLY_ADOPTER_ROLE(): ethereum.CallResult<Bytes> {
    let result = super.tryCall(
      "EARLY_ADOPTER_ROLE",
      "EARLY_ADOPTER_ROLE():(bytes32)",
      []
  ...
  getTokenId(owner: Address): BigInt {
  ...
  try_getTokenId(owner: Address): ethereum.CallResult<BigInt> {
  ...
  getURI(owner: Address): string {
    let result = super.call("getURI", "getURI(address):(string)", [
      ethereum.Value.fromAddress(owner)
    ]);
  ...
  try_getURI(owner: Address): ethereum.CallResult<string> {
    let result = super.tryCall("getURI", "getURI(address):(string)", [
      ethereum.Value.fromAddress(owner)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
